...
CO_Conc=(5 10 15 20 25 30 35 40 60 80 100)
...
mkdir /home/devbot/Geant4_Workspace/RPCDetector/data_conc/

file_name="/home/devbot/Geant4_Workspace/RPCDetector/data_conc/CO_"$CO"_Energy_"$energ"MeV.txt"
#echo $file_name
